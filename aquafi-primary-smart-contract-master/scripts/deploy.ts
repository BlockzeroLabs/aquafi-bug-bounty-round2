...
const deployContract = async () => {
  ...
  const aqua = await ethers.getContractFactory("AquaProtocol");
  const a = await aqua.deploy(
    "0xaa695B583415F4E99bdf011ba449B382A1a11268", // aqua-premium
    "0x21fcf41D7C48B2a5fF70503Bf579FA34AAb72394",
    "0x895a4e287d7F2D7E7241ED66c88b67e9d931A2B0", // oracle address
    "0xc778417E063141139Fce010982780140Aa0cD5Ab",
    "0xF7a63a49FEf8015eB45a0D4e60d1bd8EAeE14cDD"
    );
  console.log("Integrator deployed to:", a.address);
  // let a = await aqua.attach("0xf5b075f5d5931B4564Cc33D3b1D834B19C2a71D2");
  // await a.updateOracleAddress("0x8a424cFa014a59779A016eEB6Ccd8539561530C9");
  // console.log("Done");
}
